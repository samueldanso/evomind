...
**Phase B — SHIPPED as v0.1.0** (all tasks done, reviewed, tagged)
...
- T5 ✅ — artifact viewer + iframe srcdoc (`/artifacts/[slug]`), HTML route with path confinement + CSP
- Portal tests: 33 vitest tests covering all API routes
- CI: pytest + vitest + bun build gates on every push

**Phase C — next** (RAG layer via sqlite-vec — "ask your research" chat interface)
